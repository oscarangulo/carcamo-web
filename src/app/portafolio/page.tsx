...
export default function Portafolio() {
  ...
  const lightboxItem: LightboxItem | null = selectedWork && {
    src: selectedWork.src,
    title: selectedWork.title,
    caption: `${selectedWork.location}${selectedWork.year ? ` — ${selectedWork.year}` : ""}`,
  };
                ...
                >
                  ...
                  >
                    <div className="img-zoom aspect-[4/5] relative bg-stone/20">
                      {/* Cualquiera de las 4 primeras puede ser el LCP según las columnas que muestre el viewport. */}
                      <Image
                        src={work.src}
